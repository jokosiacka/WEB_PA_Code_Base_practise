...
def get_actors():
    return data_manager.execute_select('SELECT name, id FROM actors ORDER BY name LIMIT 20;')


def get_actors_genres(actor_id):
    return data_manager.execute_select("""
        SELECT   
        ...
        GROUP BY actors.id;""", {"actor_id": actor_id}, fetchall=False)
